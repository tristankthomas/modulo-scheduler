; ModuleID = 'kernel_4.cpp_mem2reg_constprop_simplifycfg.ll'
...
for.body:                                         ; preds = %for.body, %entry
  %a.addr.03 = phi i32 [ %a, %entry ], [ %rem, %for.body ]
  %i.02 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  %c.addr.01 = phi i32 [ %c, %entry ], [ %add11, %for.body ]
  %add = add nsw i32 %b, 50
  %add1 = add nsw i32 %n, 100
  %mul = mul nsw i32 %add, %add1
  %add2 = add nsw i32 %c.addr.01, 40
  %mul3 = mul nsw i32 %mul, %add2
  %add4 = add nsw i32 %a.addr.03, 10
  %mul5 = mul nsw i32 %mul3, %add4
  %add6 = add nsw i32 %c.addr.01, %n
